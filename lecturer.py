...
class Module_page(App):
    ...
    #def __init__(self, **kwargs):
       ...
       # super().__init__(**kwargs)
        ...
        Lecturer_Name = TextInput(multiline=False, size_hint_y=None, size_hint_x=None, height=40, width=300)  # defining self.ip...
        ...
        Lecturer_Availability = TextInput(multiline=False, size_hint_y=None, size_hint_x=None, height=40, width=300)  # defining self.ip...
